...
export function Sidebar({ role, collapsed = false }: SidebarProps) {
  ...
  const ceoLinks = [
    ...
    { icon: Megaphone, label: "Announcements", path: "/ceo/announcements" },
    { icon: Vote, label: "Quick Polls", path: "/ceo/polls" },
    { icon: Mic, label: "Voice Notes", path: "/ceo/voice-notes" },
  ...
  const employeeLinks = [
    ...
    { icon: UserCheck, label: "Client Portal", path: "/employee/client-portal" },
    { icon: FileStack, label: "Deal Templates", path: "/employee/deal-templates" },
    { icon: GraduationCap, label: "Mentorship", path: "/employee/mentorship" },
    { icon: Target, label: "Goals & OKRs", path: "/employee/okrs" },
    { icon: Megaphone, label: "Announcements", path: "/employee/announcements" },
    { icon: Vote, label: "Quick Polls", path: "/employee/polls" },
    { icon: Mic, label: "Voice Notes", path: "/employee/voice-notes" },
